...
messages.forEach(message => {
    ...
    <input type="text" id="input" class="no-border" placeholder="Type a message" style="width: 80%; height: 100%">
...
`;
    ...
    reply.style.padding = '0.2em';
    reply.style.backgroundColor = 'grey';
    reply.style.color = 'white';
    reply.style.borderRadius = '0.2em'
